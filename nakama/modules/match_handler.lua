...
local ZONE_PHASES = {
  { radius = 74, dps = 1,  duration = 200 },
  { radius = 56, dps = 2,  duration = 150 },
  { radius = 37, dps = 4,  duration = 120 },
  { radius = 19, dps = 8,  duration = 90  },
  { radius = 6,  dps = 16, duration = 60  },
}
local SHRINK_DURATION   = 30

local POIS = {
  { name = "Town",    x = 40,  z = 0   },
  { name = "Factory", x = 0,    z = 40 },
  { name = "Docks",   x = -40, z = 0   },
  { name = "Hilltop", x = 0,    z = -40 },
}
